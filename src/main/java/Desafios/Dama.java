...
//        O jogo de xadrez possui várias peças com movimentos curiosos: uma delas é a dama, que pode se mover qualquer
//        quantidade de casas na mesma linha, na mesma coluna, ou em uma das duas diagonais, conforme exemplifica a
//        figura abaixo:
//
//        O grande mestre de xadrez Kary Gasparov inventou um novo tipo de problema de xadrez: dada a posição de uma
//        dama em um tabuleiro de xadrez vazio (ou seja, um tabuleiro 8 × 8, com 64 casas), de quantos movimentos, no
//        mínimo, ela precisa para chegar em outra casa do tabuleiro?
//
//        Kary achou a solução para alguns desses problemas, mas teve dificuldade com outros, e por isso pediu que você
//        escrevesse um programa que resolve esse tipo de problema.
//
//        Entrada:
//
